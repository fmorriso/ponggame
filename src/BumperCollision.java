// BumperCollision.java		Mr. Poland 4/10/12
//
// Updated with the method isCollision() to help create Pong.java
...
public class BumperCollision
{
    ...
    public static boolean isCollision(Bumper bumper, Ball ball)
    {
        // see if the ball hit the bumper!
        if (bumper.inBumper(ball))
        {
